...
(function ($) {
  ...
  /*=====================
      02. Background Image js
      ==========================*/
  // Convert .bg-center parent class addition
document.querySelectorAll('.bg-center').forEach(element => {
  element.parentNode.classList.add('b-center');
});

// Convert .bg-img-cover parent class addition
document.querySelectorAll('.bg-img-cover').forEach(element => {
  element.parentNode.classList.add('bg-size');
});

// Convert background image processing
document.querySelectorAll('.bg-img-cover').forEach(element => {
